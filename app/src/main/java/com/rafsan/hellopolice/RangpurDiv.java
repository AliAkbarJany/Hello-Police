...
public class RangpurDiv extends AppCompatActivity {
   ...
   HashMap<String,String> hashMap;
    ...
    private  void rangpurDisTable(){
        ...
        hashMap.put("policeCall","Rangpur");
        ...
        hashMap.put("policeCall","Panchagarh");
        ...
        hashMap.put("policeCall","Dinajpur");
        ...
        hashMap.put("policeCall","Lalmonirhat");
        ...
        hashMap.put("policeCall","Nilphamari");
        ...
        hashMap.put("policeCall","Gaibandha");
        ...
        hashMap.put("policeCall","Thakurgaon");
        ...
        hashMap.put("policeCall","Kurigram");
