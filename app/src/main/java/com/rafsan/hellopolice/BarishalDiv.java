...
public class BarishalDiv extends AppCompatActivity {
    ...
    private  void barishalDisTable(){
        ...
        hashMap.put("policeCall","Jhalakathi");
        ...
        hashMap.put("policeCall","Patuakhali");
        ...
        hashMap.put("policeCall","Pirojpur");
        ...
        hashMap.put("policeCall","Barishal");
        ...
        hashMap.put("policeCall","Barguna");
